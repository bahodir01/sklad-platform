...
/**
 * Боковая навигация (макет заказчика §9.1). Sidebar с брендом и разделами;
 * активный пункт — мягкий бренд (bg-brand-soft), не сплошной акцент. Пункты
 * этапов 2–6 (live:false) визуально приглушены и ведут на заглушку.
 */
              ...
              return (
                ...
                >
                  ...
                  {!collapsed && item.badge != null && item.badge > 0 && (
                    <span className="ml-auto grid h-[19px] min-w-[19px] place-items-center rounded-full bg-warning px-1.5 text-[11px] font-bold tabular-nums text-warning-foreground">
                      {item.badge}
                    </span>
                  )}
                </NavLink>
